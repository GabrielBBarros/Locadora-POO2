...
public final class Imobiliaria {
	...
	public ArrayList<Usuario> clientesAluguelAtrasado(){
		...
		for(Aluguel alu: alugueis) {
			if(alu.verificaAtraso() && !cl.contains(alu.getCliente())) {
	...
	public boolean pagarAluguel(String cliente, String corretor, String imovel, float valor) {
