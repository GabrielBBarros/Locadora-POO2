...
public final class Rel_Imoveis_atrasados extends JDialog {
	private static Controlador controlador;
	private static Rel_Imoveis_atrasados relImoAtraInst;
	...
	public static void main(String[] args) {
		try {
			Rel_Imoveis_atrasados dialog = Rel_Imoveis_atrasados.getInstancia(Controlador.getInstancia());
	...
	public static Rel_Imoveis_atrasados getInstancia(Controlador control) {
		
		if(relImoAtraInst == null) {
			relImoAtraInst = new Rel_Imoveis_atrasados(control);
		}
		return relImoAtraInst;
	}
	
	private Rel_Imoveis_atrasados(Controlador control) {
		controlador = control.getInstancia();
		setBounds(100, 100, 900, 600);
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/arquivos/bandeira_brasil.jpg"));
		setTitle("Imoveis atrasados");
	...
	public void setTamDadosImoveis() {
		this.dados = new String[controlador.imoveisAtrasados().size()][14];
	}
	
	public void setTabela() {
		ArrayList<Imovel> imoveis = controlador.imoveisAtrasados();
