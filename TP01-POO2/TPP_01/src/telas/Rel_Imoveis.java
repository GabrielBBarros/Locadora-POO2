...
public final class Rel_Imoveis extends JDialog {
	...
	public static void main(String[] args) {
		try {
			Rel_Imoveis dialog = Rel_Imoveis.getInstancia(Controlador.getInstancia());
	...
	public static Rel_Imoveis getInstancia(Controlador control) {
		
		if(relImoInst == null) {
			relImoInst = new Rel_Imoveis(control);
		}
		return relImoInst;
	}
	private Rel_Imoveis(Controlador control) {
		controlador = control.getInstancia();
		setBounds(100, 100, 900, 600);
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/arquivos/bandeira_brasil.jpg"));
		setTitle("Relatorio todos imoveis");
