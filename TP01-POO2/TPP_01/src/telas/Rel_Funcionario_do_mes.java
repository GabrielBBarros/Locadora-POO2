...
public final class Rel_Funcionario_do_mes extends JDialog {
	...
	private static Rel_Funcionario_do_mes relFunMesInst;
	
	private final JPanel contentPanel = new JPanel();
	private JTable tabela;
	private String [][] dados;
	private String [] titulos = {"Ranking","Codigo", "Nome", "CPF", "RG", "Data de nascimento","Endereco","CEP", "Telefone", "E-mail", "Cresci", "Salario", "PIS", "Data Admissao"};
	private int linha;
	private int coluna;
	...
	public static Rel_Funcionario_do_mes getInstancia(Controlador control) {
		...
		if(relFunMesInst == null) {
			relFunMesInst = new Rel_Funcionario_do_mes(control);
		}
		return relFunMesInst;
	}
	
	private Rel_Funcionario_do_mes(Controlador control) {
		controlador = control.getInstancia();
		setBounds(100, 100, 900, 700);
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/arquivos/bandeira_brasil.jpg"));
		setTitle("Funcionario do mes");
