...
public final class Rel_Comercio_ainda_vingente extends JDialog {
	private static Controlador controlador;
	private static Rel_Comercio_ainda_vingente relComViInst;
	...
	public static void main(String[] args) {
		try {
			Rel_Comercio_ainda_vingente dialog = Rel_Comercio_ainda_vingente.getInstancia(Controlador.getInstancia());
	...
	public static Rel_Comercio_ainda_vingente getInstancia(Controlador control) {
		
		if(relComViInst == null) {
			relComViInst = new Rel_Comercio_ainda_vingente(control);
		}
		return relComViInst;
	}
	
	private Rel_Comercio_ainda_vingente(Controlador control) {
		controlador = control.getInstancia();
		setBounds(100, 100, 900, 600);
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/arquivos/bandeira_brasil.jpg"));
		setTitle("Comercios com contrato ainda vigente");
	...
	public void setTamDadoscasa() {
		this.dados = new String[controlador.comercioAlugadas().size()][11];
	}
	
	public void setTabela() {
		ArrayList<Imovel> casasResidenciais = controlador.comercioAlugadas();
