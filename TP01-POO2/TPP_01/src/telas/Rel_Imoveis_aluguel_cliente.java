...
public final class Rel_Imoveis_aluguel_cliente extends JDialog {
	private static Controlador controlador;
	private static Rel_Imoveis_aluguel_cliente relImoAluCliInst;
	...
	public static void main(String[] args) {
		try {
			Rel_Imoveis_aluguel_cliente dialog = Rel_Imoveis_aluguel_cliente.getInstancia(Controlador.getInstancia());
	...
	public static Rel_Imoveis_aluguel_cliente getInstancia(Controlador control) {
		
		if(relImoAluCliInst == null) {
			relImoAluCliInst = new Rel_Imoveis_aluguel_cliente(control);
		}
		return relImoAluCliInst;
	}
	
	private Rel_Imoveis_aluguel_cliente(Controlador control) {
		controlador = control.getInstancia();
		setBounds(100, 100, 900, 600);
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/arquivos/bandeira_brasil.jpg"));
		setTitle("Buscar imoveis alugados por cliente");
