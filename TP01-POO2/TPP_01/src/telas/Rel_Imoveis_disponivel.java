...
public final class Rel_Imoveis_disponivel extends JDialog {
	private static Controlador controlador;
	private static Rel_Imoveis_disponivel relImoDispInst;
	...
	public static void main(String[] args) {
		try {
			Rel_Imoveis_disponivel dialog = Rel_Imoveis_disponivel.getInstancia(Controlador.getInstancia());
	...
	public static Rel_Imoveis_disponivel getInstancia(Controlador control) {
		
		if(relImoDispInst == null) {
			relImoDispInst = new Rel_Imoveis_disponivel(control);
		}
		return relImoDispInst;
	}
	
	private Rel_Imoveis_disponivel(Controlador control) {
		controlador = control.getInstancia();
		setBounds(100, 100, 900, 600);
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/arquivos/bandeira_brasil.jpg"));
		setTitle("Imoveis disponiveis para venda e locacao");
	...
	public void setTamDadosImoveis() {
		this.dados = new String[controlador.imoveisDispo().size()][14];
	}
	
	public void setTabela() {
		ArrayList<Imovel> imoveis = controlador.imoveisDispo();
