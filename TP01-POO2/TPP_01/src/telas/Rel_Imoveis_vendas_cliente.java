...
public final class Rel_Imoveis_vendas_cliente extends JDialog {
	...
	private static Rel_Imoveis_vendas_cliente relImoVendClieInst;

	public static void main(String[] args) {
		try {
			Rel_Imoveis_vendas_cliente dialog = Rel_Imoveis_vendas_cliente.getInstancia(Controlador.getInstancia());
	...
	public static Rel_Imoveis_vendas_cliente getInstancia(Controlador control) {
		
		if(relImoVendClieInst == null) {
			relImoVendClieInst = new Rel_Imoveis_vendas_cliente(control);
		}
		return relImoVendClieInst;
	}
	
	private Rel_Imoveis_vendas_cliente(Controlador control) {
		controlador = control.getInstancia();
		setBounds(100, 100, 900, 600);
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/arquivos/bandeira_brasil.jpg"));
		setTitle("Buscar vendas por cliente");
	...
	public void setTamDadosImoveis(String codigo) {
		this.dados = new String[controlador.imoveisCompradosCliente(codigo).size()][14];
	}
	
	public void setTabela(String codigo) {
		ArrayList<Imovel> imoveis = controlador.imoveisCompradosCliente(codigo);
